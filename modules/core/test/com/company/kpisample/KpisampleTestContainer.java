...
public class KpisampleTestContainer extends TestContainer {

    public KpisampleTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/kpisample/app.properties",
    ...
    public static class Common extends KpisampleTestContainer {

        public static final KpisampleTestContainer.Common INSTANCE = new KpisampleTestContainer.Common();
